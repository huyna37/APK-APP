globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file://C:/Users/huylo/OneDrive/Documents/WEB-APK/HTML/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { defineEventHandler, handleCacheHeaders, isEvent, createEvent, getRequestHeader, splitCookiesString, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getCookie, setCookie, getRequestHeaders, setHeader, getHeader, createError, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery as getQuery$1, getResponseStatusText } from 'file://C:/Users/huylo/OneDrive/Documents/WEB-APK/HTML/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://C:/Users/huylo/OneDrive/Documents/WEB-APK/HTML/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://C:/Users/huylo/OneDrive/Documents/WEB-APK/HTML/node_modules/devalue/index.js';
import { renderSSRHead } from 'file://C:/Users/huylo/OneDrive/Documents/WEB-APK/HTML/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://C:/Users/huylo/OneDrive/Documents/WEB-APK/HTML/node_modules/ofetch/dist/node.mjs';
import destr from 'file://C:/Users/huylo/OneDrive/Documents/WEB-APK/HTML/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file://C:/Users/huylo/OneDrive/Documents/WEB-APK/HTML/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://C:/Users/huylo/OneDrive/Documents/WEB-APK/HTML/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file://C:/Users/huylo/OneDrive/Documents/WEB-APK/HTML/node_modules/scule/dist/index.mjs';
import { klona } from 'file://C:/Users/huylo/OneDrive/Documents/WEB-APK/HTML/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://C:/Users/huylo/OneDrive/Documents/WEB-APK/HTML/node_modules/defu/dist/defu.mjs';
import { hash } from 'file://C:/Users/huylo/OneDrive/Documents/WEB-APK/HTML/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file://C:/Users/huylo/OneDrive/Documents/WEB-APK/HTML/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/Users/huylo/OneDrive/Documents/WEB-APK/HTML/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/Users/huylo/OneDrive/Documents/WEB-APK/HTML/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/Users/huylo/OneDrive/Documents/WEB-APK/HTML/node_modules/radix3/dist/index.mjs';
import * as csrf from 'file://C:/Users/huylo/OneDrive/Documents/WEB-APK/HTML/node_modules/uncsrf/dist/csrf.node.mjs';
import { importEncryptSecret } from 'file://C:/Users/huylo/OneDrive/Documents/WEB-APK/HTML/node_modules/uncsrf/dist/csrf.node.mjs';
import robots from 'file://C:/Users/huylo/OneDrive/Documents/WEB-APK/HTML/.nuxt/robots.mjs';
import { version, unref } from 'file://C:/Users/huylo/OneDrive/Documents/WEB-APK/HTML/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file://C:/Users/huylo/OneDrive/Documents/WEB-APK/HTML/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://C:/Users/huylo/OneDrive/Documents/WEB-APK/HTML/node_modules/@unhead/shared/dist/index.mjs';
...
const _inlineRuntimeConfig = {
  ...
  "csurf": {
    ...
    "encryptSecret": "123456789iamasecret987654321look"
  }
};
...
const serverAssets = [{"baseName":"server","dir":"C:/Users/huylo/OneDrive/Documents/WEB-APK/HTML/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\huylo\\OneDrive\\Documents\\WEB-APK\\HTML","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\huylo\\OneDrive\\Documents\\WEB-APK\\HTML\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\huylo\\OneDrive\\Documents\\WEB-APK\\HTML\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\huylo\\OneDrive\\Documents\\WEB-APK\\HTML\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:\\Users\\huylo\\OneDrive\\Documents\\WEB-APK\\HTML\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _wdw8GvMqoq = defineNitroPlugin((nitroApp) => {
...
const _Tmus5lz51P = (function(nitro) {
...
const _nnDsiS = defineEventHandler(async (event) => {
...
const _f11NgE = defineEventHandler(async (event) => {
...
const _lazy_UPdc3Z = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_UPdc3Z, lazy: true, middleware: false, method: undefined },
  { route: '/robots.txt', handler: _nnDsiS, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _f11NgE, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_UPdc3Z, lazy: true, middleware: false, method: undefined }
];
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Tuyển tập những truyện mới nhất | Truyenvui.online"},{"name":"format-detection","content":"telephone=no"},{"name":"keywords","content":"Truyenvui.online, Truyenvui luôn cập nhật 24/24"},{"name":"og:title","content":"Tuyển tập những truyện mới nhất | Truyenvui.online"},{"name":"og:description","content":"Truyện Mới hàng ngày!"},{"name":"og:image","content":"https://s199.imacdn.com/tt24/2022/08/20/a1d6f1225feaed6f_3dcdf651b16b6157_78077166097978499674.jpg"},{"name":"og:image:width","content":"512"},{"name":"og:image:height","content":"512"},{"name":"robots","content":"index,follow"},{"name":"revisit-after","content":"1 days"},{"name":"ROBOTS","content":"index,follow,noodp"},{"name":"googlebot","content":"index,follow"},{"name":"BingBOT","content":"index,follow"},{"name":"yahooBOT","content":"index,follow"},{"name":"slurp","content":"index,follow"},{"name":"msnbot","content":"index,follow"},{"name":"monetag","content":"b09f338d34fa492356d6fc35ad3657d5"}],"link":[{"rel":"canonical","href":"https://Truyenvui.online/"},{"rel":"stylesheet","href":"/css/main-body.css","crossorigin":"anonymous"},{"rel":"stylesheet","href":"/css/apkpure.css","crossorigin":"anonymous"},{"rel":"stylesheet","href":"/css/detail.css","crossorigin":"anonymous"}],"style":[],"script":[{"src":"https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js","crossorigin":"anonymous"},{"src":"https://cdnjs.cloudflare.com/ajax/libs/jquery/3.7.1/jquery.min.js","integrity":"sha512-v2CJ7UaYy4JwqLDIrZUI/4hqeoQieOmAZNXBeQyjo21dadnwR+8ZaIJVT8EE2iyI61OV8e6M8PP2/4hpQINQ/g==","crossorigin":"anonymous","referrerpolicy":"no-referrer"},{"src":"/js/main.js","crossorigin":"anonymous"}],"noscript":[],"title":"APK","htmlAttrs":{"lang":"en"}};
...
const getClientManifest = () => import('file://C:/Users/huylo/OneDrive/Documents/WEB-APK/HTML/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
